...
let ccall arch ooid prim args =
  ...
  | _ ->
    begin
      ...
      | "caml_avr_spi_init_master" | "caml_avr_spi_init_slave" | "caml_avr_spi_transmit"
      ...
      | "caml_esp8266_serial_init" | "caml_esp8266_serial_write_char" | "caml_esp8266_serial_read_char"

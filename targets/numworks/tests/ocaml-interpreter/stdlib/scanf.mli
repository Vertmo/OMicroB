...
(** Closes the {!in_channel} associated with the given
...
type ('a, 'b, 'c, 'd) scanner =
     ('a, Scanning.in_channel, 'b, 'c, 'a -> 'd, 'd) Format.format6 -> 'c
(** The type of formatted input scanners: [('a, 'b, 'c, 'd) scanner]
    ...
    specified by [fmt], reading those arguments from {!stdin} as
    expected.
...
val bscanf_format :
  Scanning.in_channel -> ('a, 'b, 'c, 'd, 'e, 'f) Format.format6 ->
    (('a, 'b, 'c, 'd, 'e, 'f) Format.format6 -> 'g) -> 'g
...
val sscanf_format :
  string -> ('a, 'b, 'c, 'd, 'e, 'f) Format.format6 ->
    (('a, 'b, 'c, 'd, 'e, 'f) Format.format6 -> 'g) -> 'g
...
val format_from_string :
  string ->
    ('a, 'b, 'c, 'd, 'e, 'f) Format.format6 -> ('a, 'b, 'c, 'd, 'e, 'f) Format.format6
...
(** @deprecated [Scanf.fscanf] is error prone and deprecated since 4.03.0.
    ...
    If you need to read from a {!in_channel} input channel
...
val kfscanf :
  in_channel -> (Scanning.in_channel -> exn -> 'd) ->
    ('a, 'b, 'c, 'd) scanner
